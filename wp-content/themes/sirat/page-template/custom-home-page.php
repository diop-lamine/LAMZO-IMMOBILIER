...
<section id="slider">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
        ...
        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          ...
          <div class="carousel-caption">
            <div class="inner_carousel">
              ...
              <div class="more-btn">
                <a href="<?php echo esc_url(get_permalink()); ?>" alt="<?php the_title(); ?>"><?php esc_html_e( 'READ MORE', 'sirat' ); ?>
    ...
    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev" alt="<?php esc_html_e( 'carousel prev', 'sirat' ); ?>">
      <span class="carousel-control-prev-icon" aria-hidden="true"><i class="fas fa-chevron-left"></i></span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next" alt="<?php esc_html_e( 'carousel next', 'sirat' ); ?>">
          ...
          <?php
            ...
            <div class="col-lg-4 col-md-4">
              <div class="serv-box">
                ...
                <a href="<?php the_permalink(); ?>" alt="<?php the_title(); ?>"><i class="fas fa-arrow-right"></i>
                <span class="screen-reader-text"><?php the_title(); ?></span></a>
              </div>
            </div>
            <?php endwhile;
