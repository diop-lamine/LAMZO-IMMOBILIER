    ...
    <footer>
        ...
        <div id="footer-2">
          	<div class="copyright container">
                ...
                if($theme_lay == 'Left'){ ?>
                  <a href="#" class="scrollup left" alt="<?php esc_html_e( 'Scroll Up', 'sirat' ); ?>"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                <?php }else if($theme_lay == 'Center'){ ?>
                  <a href="#" class="scrollup center" alt="<?php esc_html_e( 'Scroll Up', 'sirat' ); ?>"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                <?php }else{ ?>
                  <a href="#" class="scrollup" alt="<?php esc_html_e( 'Scroll Up', 'sirat' ); ?>"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                <?php }?>
